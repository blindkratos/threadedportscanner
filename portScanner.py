...
def scan_ports(host, ports):
    print(f'Scanning IP: {host} , Ports: {ports[0]} to {ports[-1]}')
    with ThreadPoolExecutor(len(ports)) as executor: # assigning ThreadPoolExecutor with argument length of list of ports as max_workers to variable name 'executor'
